...
public class FileQueueTest {
    ...
    private FileQueueService target;
...
//        System.out.println("Preparing root dir: " + dir.getAbsolutePath());
    ...
    @Before
    public void setup() {
        File testRoot = createUnitTestDir();
        target = new FileQueueService(testRoot.getAbsolutePath(), URL_PREFIX, PULL_WAIT_TIME_MILLIS, VISIBILITY_TIMEOUT_MILLIS);
    }
    ...
    @AfterClass
    public static void cleanupAllTests() throws IOException {
        cleanupDirectory(testRootDir);
    }
...
//                .peek(System.out::println)
    ...
    @Test
    public void can_create_a_single_queue_service() throws IOException {
...
//        }
    ...
    @Test
    public void can_create_a_service_with_2_queues() throws IOException {
    ...
    @Test
    public void can_create_a_service_with_5_queues() throws IOException {
